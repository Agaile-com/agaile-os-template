---
description: Create an AgAIle OS tasks list from an approved feature spec
globs:
alwaysApply: false
version: 1.1
encoding: UTF-8
...
Use the file-creator subagent to create file: tasks.md inside of the current feature's feature folder.
...
<readiness_summary>
<present_to_user> - Feature name and description - First task summary from tasks.md - Estimated complexity/scope - Key deliverables for task 1
</present_to_user>
</readiness_summary>

<execution_prompt>
PROMPT: "The feature planning is complete. The first task is:
...
REFERENCE: @.agaile-os/instructions/core/execute-tasks.md
