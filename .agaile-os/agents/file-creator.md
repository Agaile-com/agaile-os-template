...
- Tasks: @.agent-os/feature s/[FOLDER]/tasks.md
- Technical Specification: @.agent-os/feature s/[FOLDER]/sub-specs/technical-spec.md
[ADDITIONAL_DOCS]
```
...
This is the technical specification for the feature detailed in @.agent-os/feature s/[FOLDER]/feature .md
...
This is the database schema implementation for the feature detailed in @.agent-os/feature s/[FOLDER]/feature .md
...
This is the API specification for the feature detailed in @.agent-os/feature s/[FOLDER]/feature .md
...
This is the tests coverage details for the feature detailed in @.agent-os/feature s/[FOLDER]/feature .md
...
These are the tasks to be completed for the feature detailed in @.agent-os/feature s/[FOLDER]/feature .md
...
### Single File Request
```
Create file: .agent-os/feature s/2025-01-29-auth/feature .md
...
Directory: .agent-os/feature s/2025-01-29-user-auth/
Files:
- feature.md (content: [provided])
...
### Success
```
✓ Created directory: .agent-os/feature s/2025-01-29-user-auth/
✓ Created file: feature.md
