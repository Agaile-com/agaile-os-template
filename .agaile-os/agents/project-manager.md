...
1. **Task Completion Verification**: Check if feature tasks have been implemented and completed according to requirements
...
- **Task Files**: .agent-os/feature s/[dated specs folders]/tasks.md
