...
### Branch Naming
- Extract from feature folder: `2025-01-29-feature-name` → branch: `feature-name`
- Remove date prefix from feature folder names
...
- Include feature reference if applicable
...
- Spec: .agent-os/feature s/2025-01-29-password-reset/
...
## Related
- Spec: @.agent-os/feature s/[spec-folder]/
